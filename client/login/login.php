...
if (!empty($_POST['loginButton'])) {
    ...
    if (!empty($body['email'] && !empty($body['password']))) {
        ...
        $clientDetail = firstRaw("SELECT * FROM client WHERE email='$email'");
...
<div class="mb">
    ...
    <div class="box_content form_account">
        <form action="#" method="POST" style="text-align: left;">
            ...
            <button class="btn btn-warning btn-sm"><a href="<?php echo _WEB_HOST_ROOT . '/admin' ?>"
                    style="text-decoration: none; color: black" target="_blank">Trang quản
                    trị</a></button>
            <?php endif; ?>
            <button class="btn btn-success btn-sm"><a href="?module=cart&action=lists"
                    style="text-decoration: none; color: white">GIỎ HÀNG <i
