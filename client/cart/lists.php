                                ...
                                <tr>
                                    ...
                                    <td class="text-center">
                                        ...
                                        <a href="?module=cart&action=plus&id=<?php echo $item['id'] ?>">
                                            <button class="btn btn-primary btn-sm plus-<?php echo $count; ?>"><i class="fa fa-plus"></i></button>
                                        </a>
                                    </td>
                                    <td><?php echo $totalPrice ?></td>
                                    <td width="5%"><a href="?module=cart&action=delete&id=<?php echo $item['id'] ?>"><button class="btn btn-danger btn-sm">Xóa</button></a></td>
                                </tr>
                        <?php endforeach;
                        endif;  ?>
                    </tbody>
