        ...
        <header>
            ...
            <div class="row mb menu">
                <ul>
                    ...
                    <li
                        class="<?php echo (empty($_GET['module']) || (!empty($_GET['module']) && $_GET['module'] == 'category')) ? 'active' : 'Sai dieu kien' ?>">
                        <a href="?module=products_category">Danh mục <i class="fa-solid fa-bars"></i></a>
                    </li>
                    <li
                        class="<?php echo (!empty($_GET['module']) && $_GET['module'] == 'products') ? 'active' : false ?>">
                        <a href="?module=products">Hàng hóa <i class="fa-solid fa-mobile-screen"></i></a>
                    </li>
                    <li
                        class="<?php echo (!empty($_GET['module']) && $_GET['module'] == 'clients') ? 'active' : false ?>">
                        <a href="?module=clients">Khách hàng <i class="fa fa-user"></i></a>
                    </li>
                    <li
                        class="<?php echo (!empty($_GET['module']) && $_GET['module'] == 'comments') ? 'active' : false ?>">
                        <a href="?module=comments">Bình luận <i class="fa fa-comment"></i></a>
                    </li>
                    <li
                        class="<?php echo (!empty($_GET['module']) && $_GET['module'] == 'statistic') ? 'active' : false ?>">
                    ...
                    <li
                        class="<?php echo (!empty($_GET['action']) && $_GET['module'] == 'manager') ? 'active' : false ?>">
                        <a href="?module=manager&action=add">Thêm Quản trị viên <i class="fa fa-user-cog"></i></a>
                    </li>
                    <?php endif; ?>
                    <li
                        class="<?php echo (!empty($_GET['module']) && empty($_GET['action']) && $_GET['module'] == 'manager') ? 'active' : false ?>">
                        <a href="?module=manager">Quản trị viên <i class="fa fa-user-cog"></i></a>
                    </li>
                    <li
                        class="<?php echo (!empty($_GET['module']) && $_GET['module'] == 'options') ? 'active' : false ?>">
