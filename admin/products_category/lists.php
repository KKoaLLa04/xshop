...
if (isLogin()) {
    ...
    $listCateProduct = adminProductCate($filter, $offset, $perPage);
}
...
<div class="row2">
    ...
    <div class="row2 form_content ">
                ...
                <?php if (!empty($listCateProduct)) :
                    foreach ($listCateProduct as $item) : ?>
                        <tr>
                            ...
                            <td><a href="?module=products_category&action=update&id=<?php echo $item['id'] ?>"><button class="btn btn-warning">Sửa <i class="fa fa-edit"></i></button></a></td>
                            <td><a href="?module=products_category&action=delete&id=<?php echo $item['id'] ?>" onclick="return confirm('Bạn có chắc chắn muốn xóa?')"><button class="btn btn-danger">Xóa <i class="fa fa-trash-alt"></i></button></a></td>
                        </tr>
        ...
        <a href="?module=products_category&action=add"><button type="button" class="btn btn-primary btn-sm">Thêm mới <i class="fa fa-plus"></i></button></a>
    </div>
</div>
<?php
