...
$listAllClients = getRaw("SELECT * FROM client WHERE position <> 0 ORDER BY position DESC LIMIT $offset, $perPage");
...
<div class="row2">
    ...
    <div class="row2 form_content ">
        ...
        <table class="table table-bordered my-4">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td><a href="?module=manager&action=update&id=<?php echo $item['id'] ?>"><button
                                class="btn btn-warning btn-sm">Sửa <i class="fa fa-edit"></i></button></a>
                        <?php if ($item['id'] !== $clientId) : ?>
                    <td><a href="?module=manager&action=delete&id=<?php echo $item['id'] ?>"
        ...
        <a href="?module=manager&action=add" class="btn btn-primary btn-sm">Thêm quản trị viên <i
        ...
        <nav aria-label="Page navigation example" class="d-flex justify-content-end btn-sm">
            <ul class="pagination">
                ...
                <li class="page-item"><a class="page-link"
                        href="?module=manager&page=<?php echo $i ?>"><?php echo $i ?></a></li>
                <?php endfor; ?>
                <?php if ($page < $maxPage) :
                    $next = $page + 1;
                ?>
